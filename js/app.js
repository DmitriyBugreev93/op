...
var ScrollToPlugin_ScrollToPlugin = {
  version: "3.12.5",
  name: "scrollTo",
  rawVars: 1,
...
ScrollToPlugin_ScrollToPlugin.max = _max;
ScrollToPlugin_ScrollToPlugin.getOffset = _getOffset;
ScrollToPlugin_ScrollToPlugin.buildGetter = _buildGetter;
ScrollToPlugin_getGSAP() && ScrollToPlugin_gsap.registerPlugin(ScrollToPlugin_ScrollToPlugin);

// EXTERNAL MODULE: ./node_modules/gsap/SplitText.min.js
var SplitText_min = __webpack_require__(250);
...
function plugins() {
  ...
  window.ScrollToPlugin = ScrollToPlugin_ScrollToPlugin;
  window.SplitText = SplitText_min.SplitText;
}
...
function getElementBy(selector, parent = document) {
  return parent.querySelector(selector);
}
function getElementsBy(selector, parent = document) {
  return parent.querySelectorAll(selector);
}
function queryMatches(pxl, query) {
...
core.use([Navigation, Pagination, Autoplay, EffectCards]);
...
function intro() {
  ...
  //intro slider
  let swiperEffect = new core(".intro__swiper", {
    // modules:
    loop: true,
    direction: "vertical",
    cardsEffect: {
...
;// CONCATENATED MODULE: ./src/js/sections/about.js
      ...
      scrollTrigger: {
        ...
        onEnter: () => {
          if (!done) {
            ...
            // addClassName(cards[0], "activated");
          }
        },
      },
    });
...
;// CONCATENATED MODULE: ./src/js/sections/floorplan.js
...
function floorplan() {
  ...
  sliders.forEach((slider, index) => {
    Oe.bind(`[data-fancybox="gallery-${index + 1}"]`, {
      Thumbs: {
        type: "classic",
      },
      on: {
...
;// CONCATENATED MODULE: ./src/js/components/links.js
...
;// CONCATENATED MODULE: ./src/js/sections/brochure.js
...
;// CONCATENATED MODULE: ./src/js/sections/location.js
...
;// CONCATENATED MODULE: ./src/js/sections/payment.js
...
;// CONCATENATED MODULE: ./src/js/sections/developer.js
...
;// CONCATENATED MODULE: ./src/js/sections/popup.js
...
;// CONCATENATED MODULE: ./src/js/components/btns.js
...
;// CONCATENATED MODULE: ./src/js/sections/axcapital.js
...
function investment() {
  ...
  // let investmentTexts = getElementsBy(".investment__item-text");
  // investmentTexts.forEach((text) => {
  //   new SplitText(text, { type: "lines,words", linesClass: "investment__item-hidden", wordsClass: "investment__item-words" });
  // });
  // if (queryMatches(100, "min")) {
  items.forEach((item) => {
  ...
  //       scrollTrigger: {
  //         trigger: item,
  //         start: `bottom+=200px 100%`,
  //         end: "bottom+=200px 100%",
  //         // markers: true,
  //         onEnter: () => {
  //           items.forEach((item, i) => {
  //             removeClassName(item, "active");
...
;// CONCATENATED MODULE: ./src/js/components/forms.js
